...
const GROUND_VERT_PATH: &str = "shaders/racing/rails.vert";
const GROUND_FRAG_PATH: &str = "shaders/racing/rails.frag";
...
impl Material for RailsMaterial {
